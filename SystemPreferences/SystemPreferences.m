...
- (void)runInfoPanel:(id)sender
{
  ...
  [d setObject: @"SystemPreferences 1.0" forKey: @"ApplicationRelease"];
  [d setObject: @"December 2005" forKey: @"FullVersionID"];
  ...
  [d setObject: @"Copyright (C) 2005 Free Software Foundation, Inc."
        forKey: @"Copyright"];
